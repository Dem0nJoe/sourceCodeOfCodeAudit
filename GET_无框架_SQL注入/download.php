  ...
  <div id="dc">
      ...
      <div class="dc_l_c">
        <div class="dc_l_c_c">
          <ul>
			...
			if($id==""){
			  $subPage_link="download.php?page=";
			  $query="select count(*) as total from xy_download order by id desc";
			  $sqlsql = "select * from xy_download order by id desc limit $sub_nums,$page_size";
			}
			else
			{
			  $subPage_link="download.php?id=$id&page=";
			  $query="select count(*) as total from xy_download where p_id=$id order by id desc";
			  $sqlsql = "select * from xy_download where p_id=$id order by id desc limit $sub_nums,$page_size";
			}
			...
			?>
            <li><span><?php echo $rs['c_date'];?></span><a href="showdownload.php?id=<?php echo $rs['id'];?>" target="_self"><?php echo $rs['title'];?></a></li>
			<?php } ?>
          </ul>
          <div class="clear"></div>
    ...
    <div class="dc_r">
      ...
      <div class="dc_r_c">
        <div class="dc_r_c_c">
          <ul>
            <?php echo xycms_list("down_fl","download.php");?>
          </ul>
        </div>
      </div>
      <div class="dc_r_t">
