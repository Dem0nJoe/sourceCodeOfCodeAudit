          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[添加招聘信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        ...
        <td class="td"><input name="renshu" type="text" id="renshu" value="" size="4" /> [单位：人]</td>
      </tr>
      <tr onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
      ...
      <tr onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        ...
        <td class="td"><input type="radio" name="sex" id="radio" value="男" checked="checked" />男 <input type="radio" name="sex" id="radio" value="女" />女 <input type="radio" name="sex" id="radio" value="不限" />不限</td>
      </tr>
      <tr  onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
...
if($_GET["act"]){
  ...
  $sql="insert into xy_zp set title='$title',keywords='$keywords',descriptions='$descriptions',renshu='$renshu',degree='$degree',sex='$sex',content='$content',c_date=now()";
  mysql_query($sql);
  mysql_close($conn);
  echo "<script language='javascript'>"; 
  echo "alert('恭喜您，信息添加成功，点击继续添加!');";
  echo " location='add_careers.php';"; 
  echo "</script>";
}
?>
