...
if($_GET["act"]){
  ...
  $sql="update news set title='$title',keywords='$keywords',descriptions='$descriptions',p_id='$p_id',img='$img',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now() where id=$id";
  mysql_query($sql);
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[修改新闻信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8" >
       ...
       <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8" >
        <td height="28" width="10%" class="td">新闻分类</td>
        <td width="90%"  class="td">
          <select name="p_id" id="p_id">
            <?php
            $conet="select * from news_fl order by pl_id asc";
