...
if($_GET["act"]){
  ...
  $sql="update xy_pro set title='$title',keywords='$keywords',descriptions='$descriptions',p_id='$p_id',img='$img',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now() where id=$id";
  mysql_query($sql);
...
$cid=$_GET['id'];
$sql="select * from xy_pro where id=$cid";
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[修改产品信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
       ...
       <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8" >
        ...
        <td width="90%"  class="td">
          <select name="p_id" id="p_id">
            <?php
            $conet="select * from pro_fl order by pl_id asc";
