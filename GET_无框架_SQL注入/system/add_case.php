          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[添加客户案例信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        ...
        <td class="td"><textarea name="case_dc" cols="50" rows="4"></textarea></td>
      </tr>
    <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        <td height="25" class="td">缩略图</td>
        <td class="td"><input name="img" type="text" id="img"  size="30" />
...
if($_GET["act"]){
  ...
  $sql="insert into xy_case set title='$title',keywords='$keywords',descriptions='$descriptions',case_dc='$case_dc',img='$img',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now()";
  mysql_query($sql);
  mysql_close($conn);
  echo "<script language='javascript'>"; 
  echo "alert('恭喜您，信息添加成功，点击继续添加!');";
  echo " location='add_case.php';"; 
  echo "</script>";
}
?>
