...
if($_GET["act"]){
  ...
  $sql="update common set title='$title',keywords='$keywords',descriptions='$descriptions',pl_id='$pl_id',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now() where id=$id";
  mysql_query($sql);
...
$cid=$_GET['id'];
$sql="select * from common where id=$cid";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        ...
        <td class="td"><input name="pl_id" type="text" size="30" value="<?php echo $rs["pl_id"];?>"  /></td>
      </tr>
      <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
