...
if($_GET["act"]){
  ...
  $case_dc=$_POST['case_dc'];
  $img=$_POST['img'];
  $info_from=$_POST['info_from'];
  $info_auth=$_POST['info_auth'];
  $content=$_POST['content'];
  $sql="update xy_case set title='$title',keywords='$keywords',descriptions='$descriptions',case_dc='$case_dc',img='$img',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now() where id=$id";
  mysql_query($sql);
...
$cid=$_GET['id'];
$sql="select * from xy_case where id=$cid";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[修改客户案例信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        <td height="25" width="10%" class="td">案例简介</td>
        <td class="td"><textarea name="case_dc" cols="50" rows="4"><?php echo $rs["case_dc"];?></textarea></td>
      </tr>
    <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
        <td height="25" class="td">缩略图</td>
        <td class="td"><input name="img" type="text" id="img"  size="30" value="<?php echo $rs["img"];?>" />
         <input type="button" id="image" value="选择图片" class="button" /></td>
      </tr>
      <tr  onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
