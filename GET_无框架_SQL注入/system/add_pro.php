          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[添加产品信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
...
if($_GET["act"]){
  ...
  $sql="insert into xy_pro set title='$title',keywords='$keywords',descriptions='$descriptions',p_id='$p_id',img='$img',info_from='$info_from',info_auth='$info_auth',content='$content',c_date=now()";
  mysql_query($sql);
  mysql_close($conn);
  echo "<script language='javascript'>"; 
  echo "alert('恭喜您，信息添加成功，点击继续添加!');";
  echo " location='add_pro.php';"; 
  echo "</script>";
}
?>
